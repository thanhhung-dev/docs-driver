...
3.  **Hệ thống Cảnh báo Hai Cấp độ:** Cảnh báo sớm nhẹ nhàng (âm thanh, LED màu) và cảnh báo khẩn cấp (âm thanh dồn dập, LED nhấp nháy).
4.  **Ghi Log Sự kiện:** Ghi lại tất cả các sự kiện vào tệp log hoặc cơ sở dữ liệu SQLite.
5.  **Lưu Bằng chứng:** Tự động chụp và lưu lại hình ảnh tại thời điểm có cảnh báo khẩn cấp.
6.  **Hỗ trợ một Nền tảng:** Tối ưu hóa để hệ thống chạy ổn định và hiệu quả trên MỘT nền tảng phần cứng được chọn (Jetson Nano hoặc Raspberry Pi 4).

## 3.2 Post-MVP Features (Tính năng phát triển sau Đồ án)

Các tính năng có thể phát triển sau khi hoàn thành MVP: Nhận dạng hành vi phức tạp hơn (uống nước, hút thuốc), hỗ trợ đa nền tảng phần cứng, xây dựng giao diện người dùng đồ họa (GUI), và hoàn thiện cơ chế cập nhật OTA (Over-The-Air) từ xa.
